...
class Chat extends PureComponent {
    constructor(props) {
        ...
        this.getOptionsPromise = this.makeGetOptionsPromise();
    }
    ...
    makeGetOptionsPromise = () => () => lastValueFrom(of([this.userSuggestions]));
    ...
    ignoreChatListElScrollTrue = () => {
        this.ignoreChatListElScroll = true
    };

    ignoreChatListElScrollFalse = () => {
        this.ignoreChatListElScroll = false
    };
