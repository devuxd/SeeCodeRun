           ...
           ref={ref => this.makeDraggableAndResizable(ref)}>
        {
          ...
          <Card className={classes.chatContent}>
            ...
            <CardContent className={classes.chatMessages}>
              <MenuItem>blalalalalal1</MenuItem>
              <MenuItem>blalalalalal</MenuItem>
              <MenuItem>blalalalalal</MenuItem>
              <MenuItem>blalalalalal</MenuItem>
              <MenuItem>blalalalalal</MenuItem>
              <MenuItem>blalalalalal</MenuItem>
              ...
              <MenuItem>blalalalalal</MenuItem>
              <MenuItem>blalalalalal</MenuItem>
              <MenuItem>blalalalalalnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn</MenuItem>
