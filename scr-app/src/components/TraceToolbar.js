...
class InputEndAdornment extends React.Component {
  ...
  render() {
    ...
    const {isFunctions, isExpressions, isValues, isCase, isWord, isRegExp, handleFilterClick} = searchState;
    ...
    const hasSelected = isFunctions || isExpressions || isValues || isCase || isWord || isRegExp;
          ...
          : <Paper>
            <Tooltip title={"Include Functions"} placement="top">
              <Chip
                ...
                avatar={isFunctions ? <Avatar><CheckBoxIcon color="primary"/></Avatar> :
            ...
            <Tooltip title={"Include Expressions"}>
              <Chip
                ...
                classes={avatarClasses}
                avatar={isExpressions ? <Avatar><CheckBoxIcon color="primary"/></Avatar> :
                  <Avatar><CheckBoxOutlineBlankIcon color="primary"/></Avatar>}
              />
            </Tooltip>
            <Tooltip title={"Include Values"}>
              <Chip
                label="{...}"
                onClick={() => handleFilterClick('isValues')}
                classes={avatarClasses}
                avatar={isValues ? <Avatar><CheckBoxIcon color="primary"/></Avatar> :
                  <Avatar><CheckBoxOutlineBlankIcon color="primary"/></Avatar>}
              />
            </Tooltip>
            <Tooltip title={"Match Case"}>
              <Chip
                ...
                classes={avatarClasses}
                avatar={isCase ? <Avatar><CheckBoxIcon color="secondary"/></Avatar> :
            ...
            <Tooltip title={"Words"}>
              <Chip
                ...
                classes={avatarClasses}
                avatar={isWord ? <Avatar><CheckBoxIcon color="secondary"/></Avatar> :
                  <Avatar><CheckBoxOutlineBlankIcon color="secondary"/></Avatar>}
              />
            </Tooltip>
            ...
            <Tooltip title={"Regular Expression"}>
              <Chip
                ...
                classes={avatarClasses}
                avatar={isRegExp ? <Avatar><CheckBoxIcon color="secondary"/></Avatar> :
                  <Avatar><CheckBoxOutlineBlankIcon color="secondary"/></Avatar>}
              />
            </Tooltip>
          </Paper>
...
const EnhancedToolbar = props => {
  ...
  return <PastebinContext.Consumer>
    {(context) => {
      const {
      ...
      const playingIcon =
        isPlaying ? <PlayArrowIcon/> : newEntries ?
          <Badge className={classes.badge} badgeContent={newEntries > 99 ? '99+' : `${newEntries}`} color="secondary">
            <PauseIcon/>
          </Badge> : <PauseIcon/>;
      const playingButton =
        ...
        >
          {numSelected > 0 ? null : <React.Fragment>
            ...
            <Tooltip
              ...
              enterDelay={300}
            >
              <IconButton color={orderBy === 'time' ? 'primary' : 'default'} onClick={handleChangeTimeFlow}>
