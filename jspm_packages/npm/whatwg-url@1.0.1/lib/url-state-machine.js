...
(function(Buffer) {
  ...
  URLStateMachine.prototype["parse" + "scheme start"] = function parseSchemeStart(c, c_str) {
    if (isASCIIAlpha(c)) {
  ...
  URLStateMachine.prototype["parse" + "scheme"] = function parseScheme(c, c_str) {
  ...
  URLStateMachine.prototype["parse" + "no scheme"] = function parseNoScheme(c, c_str) {
  ...
  URLStateMachine.prototype["parse" + "special relative or authority"] = function parseSpecialRelativeOrAuthority(c, c_str) {
  ...
  URLStateMachine.prototype["parse" + "path or authority"] = function parsePathOrAuthority(c, c_str) {
    if (c === 47) {
  ...
  URLStateMachine.prototype["parse" + "relative"] = function parseRelative(c, c_str) {
    this.url.scheme = this.base.scheme;
    if (isNaN(c)) {
  ...
  URLStateMachine.prototype["parse" + "relative slash"] = function parseRelativeSlash(c, c_str) {
  ...
  URLStateMachine.prototype["parse" + "special authority slashes"] = function parseSpecialAuthoritySlashes(c, c_str) {
    if (c === 47 && this.input[this.pointer + 1] === 47) {
      this.state = "special authority ignore slashes";
      ++this.pointer;
    } else {
  ...
  URLStateMachine.prototype["parse" + "special authority ignore slashes"] = function parseSpecialAuthorityIgnoreSlashes(c, c_str) {
    if (c !== 47 && c !== 92) {
      this.state = "authority";
      --this.pointer;
    } else {
  ...
  URLStateMachine.prototype["parse" + "authority"] = function parseAuthority(c, c_str) {
    if (c === 64) {
      this.parse_error = true;
      if (this.at_flag) {
      ...
      this.buffer = "";
    } else if (isNaN(c) || c === 47 || c === 63 || c === 35 || (specialSchemas[this.url.scheme] !== undefined && c === 92)) {
  ...
  URLStateMachine.prototype["parse" + "host name"] = URLStateMachine.prototype["parse" + "host"] = function parseHostName(c, c_str) {
  ...
  URLStateMachine.prototype["parse" + "port"] = function parsePort(c, c_str) {
    if (isASCIIDigit(c)) {
      this.buffer += c_str;
    } else if (isNaN(c) || c === 47 || c === 63 || c === 35 || (specialSchemas[this.url.scheme] !== undefined && c === 92) || this.state_override) {
      if (this.buffer !== "") {
  ...
  URLStateMachine.prototype["parse" + "file"] = function parseFile(c, c_str) {
    ...
    if (isNaN(c)) {
      ...
      if (this.base !== null && this.base.scheme === "file") {
        if ((!isASCIIAlpha(c) || (this.input[this.pointer + 1] !== 58 && this.input[this.pointer + 1] !== 124)) || this.input.length - this.pointer - 1 === 1 || [47, 92, 63, 35].indexOf(this.input[this.pointer + 2]) === -1) {
          this.url.host = this.base.host;
          this.url.path = this.base.path.slice();
          this.url.path.pop();
        } else {
  ...
  URLStateMachine.prototype["parse" + "file slash"] = function parseFileSlash(c, c_str) {
    if (c === 47 || c === 92) {
      if (c === 92) {
        this.parse_error = true;
      }
  ...
  URLStateMachine.prototype["parse" + "file host"] = function parseFileHost(c, c_str) {
  ...
  URLStateMachine.prototype["parse" + "path start"] = function parsePathStart(c, c_str) {
  ...
  URLStateMachine.prototype["parse" + "path"] = function parsePath(c, c_str) {
    if (isNaN(c) || c === 47 || (specialSchemas[this.url.scheme] !== undefined && c === 92) || (!this.state_override && (c === 63 || c === 35))) {
      if (specialSchemas[this.url.scheme] !== undefined && c === 92) {
        this.parse_error = true;
      }
      ...
      } else if (isSingleDot(this.buffer) && c !== 47 && !(specialSchemas[this.url.scheme] !== undefined && c === 92)) {
        this.url.path.push("");
      } else if (!isSingleDot(this.buffer)) {
        if (this.url.scheme === "file" && this.url.path.length === 0 && this.buffer.length === 2 && isASCIIAlpha(this.buffer.codePointAt(0)) && (this.buffer[1] === "|" || this.buffer[1] === ":")) {
      ...
      if (c === 37 && this.input[this.pointer + 1] === 50 && (this.input[this.pointer + 2] === 101 || this.input[this.pointer + 2] === 69)) {
        this.buffer += ".";
        this.pointer += 2;
      } else {
  ...
  URLStateMachine.prototype["parse" + "non-relative path"] = function parseNonRelativePath(c, c_str) {
    if (c === 63) {
      this.url.query = "";
      this.state = "query";
    } else if (c === 35) {
  ...
  URLStateMachine.prototype["parse" + "query"] = function parseQuery(c, c_str) {
  ...
  URLStateMachine.prototype["parse" + "fragment"] = function parseFragment(c, c_str) {
