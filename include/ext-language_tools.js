ace.define("ace/snippets", ["require", "exports", "module", "ace/lib/oop", "ace/lib/event_emitter", "ace/lib/lang", "ace/range", "ace/anchor", "ace/keyboard/hash_handler", "ace/tokenizer", "ace/lib/dom", "ace/editor"], function (e, t, n) {
  ...
  var h = {
    ...
    if (e.command.name === "backspace")n && !u.getCompletionPrefix(t) && t.completer.detach(); else if (e.command.name === "insertstring") {
      ...
      r && r.length >= t.$liveAutocompletionThreshold && !n && (t.completer || (t.completer = new i), t.completer.autoInsert = !1, t.completer.showPopup(t))
    }
  };
  var lastExec_e;
  var liveAutocompleteTimer = e("../lib/lang").delayedCall(function () {
    m(lastExec_e);
  }, 0);
  ...
  e("../config").defineOptions(g.prototype, "editor", {
    ...
    enableLiveAutocompletion: {
      set: function (e) {
        e ? (this.completers || (this.completers = Array.isArray(e) ? e : c), this.commands.on("afterExec", scheduleAutocomplete)) : this.commands.removeListener("afterExec", scheduleAutocomplete)
      }, value: !1
    },
    liveAutocompletionDelay: {value: 100},
    liveAutocompletionThreshold: {value: 0},
    enableSnippets: {
      set: function (e) {
